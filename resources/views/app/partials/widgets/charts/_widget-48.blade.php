    ...
    <div class="card-header justify-content-start align-items-center pt-6">
        ...
        <div class="symbol symbol-50px me-4">
            <div class="symbol-label border border-dashed border-gray-300">
                <i class="ki-outline ki-chart-line-up-2 text-danger fs-1"></i>            </div>
        </div>
        <!--end::Symbol-->
        <!--begin::Info-->
        <div class="card-title flex-column flex-grow-1">
            <span class="card-label fw-bold fs-3 text-gray-800">Sale Grows</span>
    ...
    <div class="card-body d-flex align-items-end pb-0">
        ...
        <div class="d-flex flex-stack flex-row-fluid">
            ...
            <div class="d-flex flex-column">
                ...
                <!--end::Stats-->
                <!--begin::Total-->
                <span class="fw-semibold text-gray-500">Monthly</span>
                <!--end::Total-->
            </div>
            <!--end::Wrapper-->
            <!--begin::Chart-->
