...
<div id="kt_app_content" class="app-content flex-column-fluid">
    <h1 class="fw-bold mt-4 mb-6 ps-6">Patient Listing</h1>
            ...
            <div class="card-header border-0 pt-6">
                ...
                <div class="card-title">
                    ...
                    <div class="d-flex align-items-center position-relative my-1">
                        ...
                        <input type="text" data-kt-user-table-filter="search" class="form-control form-control-solid w-250px ps-13" placeholder="Search Patient" />
                    </div>
                    <!--end::Search-->
                </div>
                <!--begin::Card title-->
                        ...
                        <div class="modal-dialog modal-dialog-centered mw-650px">
                            ...
                            <div class="modal-content">
                                ...
                                <div class="modal-header" id="kt_modal_add_user_header">
                                    <!--begin::Modal title-->
                                    <h2 class="fw-bold">Add Patient</h2>
                                    <!--end::Modal title-->
                                    <!--begin::Close-->
                ...
                <table class="table align-middle table-row-dashed fs-6 gy-5" id="kt_table_users">
                    ...
                    <tbody class="text-gray-600 fw-semibold">
                        <tr>
                            ...
                            <td>925789545</td>
                            <td>964189545</td>
                            <td>Rua do Combatentes Nº13 4740-409</td>
                            <td>Female</td>
