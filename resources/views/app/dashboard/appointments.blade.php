            ...
            <table class="table align-middle gs-0 gy-4">
                ...
                <thead>
                    <tr class="fw-bold text-muted bg-light">
                        <th class="ps-4 min-w-225px rounded-start">Name</th>
                        <th class="min-w-200px">Type</th>
                        <th class="min-w-150px">Price</th>
                        <th class="min-w-200px">Next Due Date</th>
                        ...
                        <td>
                            <div class="d-flex align-items-center">
                                ...
                                <div class="d-flex justify-content-start flex-column">
                                    <a href="#" class="text-gray-900 fw-bold text-hover-primary mb-1 fs-6">Service Name</a>
                                </div>
                            </div>
                        </td>
                        <td>
                            <a href="#" class="text-gray-900 fw-bold text-hover-primary d-block mb-1 fs-6">VPS</a>
