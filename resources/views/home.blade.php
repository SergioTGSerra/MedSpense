            ...
            <main id="main">
                            ...
                            <div class="col-lg-7 col-xl-6 offset-xl-1">
                                ...
                                <div class="row mt-n50 mt-sm-n40">
                                    ...
                                    <div class="col-md-6 mt-50 mt-sm-40 wow fadeIn" data-wow-delay="0">
                                        <h4 class="services-6-caption">Branding</h4>
                                        <div class="services-6-separator"></div>
                                        <h5 class="services-6-title">Brand Strategy</h5>
                                    ...
                                    <div class="col-md-6 mt-50 mt-sm-40 wow fadeIn" data-wow-delay="0.05s">
                                        <h4 class="services-6-caption">Mobile & Web</h4>
                                        <div class="services-6-separator"></div>
                                        <h5 class="services-6-title">UI/UX Design</h5>
                                        <p class="services-6-text mb-0">
                                    ...
                                    <div class="col-md-6 mt-50 mt-sm-40 wow fadeIn" data-wow-delay="0.1s">
                                        <h4 class="services-6-caption">Video & Animation</h4>
                                        <div class="services-6-separator"></div>
                                        <h5 class="services-6-title">Motion Design</h5>
                                        <p class="services-6-text mb-0">
                                    ...
                                    <div class="col-md-6 mt-50 mt-sm-40 wow fadeIn" data-wow-delay="0.15s">
                                        <h4 class="services-6-caption">Marketing</h4>
                                        <div class="services-6-separator"></div>
                                        <h5 class="services-6-title">Research & Solutions </h5>
                                        <p class="services-6-text mb-0">
                ...
                <section class="page-section" id="portfolio">
                    ...
                    <div class="bg-shape-1">
                        <img src="images/demo-slick/bg-shape-1.svg" alt="" />
                    </div>
                    <!-- End Background Shape -->
                    ...
                    <div class="container position-relative">
                        ...
                        <div class="row mb-50 mb-sm-30">                            
                            <div class="col-md-8 offset-md-2 text-center">  
                                ...
                                <h2 class="section-caption-slick mb-30 mb-sm-20">Selected Work</h2>
                        ...
                        <div class="text-center mb-60 mb-sm-40">
                            <div class="works-filter works-filter-slick">
                        ...
                        <!-- Works Grid -->
                        <ul class="works-grid work-grid-3 work-grid-gut-xl work-grid-hover-alt work-grid-round masonry" id="work-grid">
                            
                            <!-- Work Item (Lightbox) -->
                            <li class="work-item mix development">
                                <a href="images/demo-slick/portfolio/project-1-large.jpg" class="work-lightbox-link mfp-image">
                                    <div class="work-img">
                                        <div class="work-img-bg wow-p scalexIn"></div>
                                        <img src="images/demo-slick/portfolio/project-1.jpg" alt="Work Description" class="wow-p fadeIn" data-wow-delay="1s" />
                                    </div>
                            ...
                            <li class="work-item mt-80 mt-sm-0 mix branding design">
                                <a href="slick-portfolio-single.html" class="work-ext-link">
                                    <div class="work-img">
                                        <div class="work-img-bg wow-p scalexIn"></div>
                                        <img src="images/demo-slick/portfolio/project-2.jpg" alt="Work Description" class="wow-p fadeIn" data-wow-delay="1s" />
                                    </div>
                                    <div class="work-intro">
                            ...
                            <li class="work-item mix branding">
                                <a href="slick-portfolio-single.html" class="work-ext-link">
                                    <div class="work-img">
                                        <div class="work-img-bg wow-p scalexIn"></div>
                                        <img src="images/demo-slick/portfolio/project-3.jpg" alt="Work Description" class="wow-p fadeIn" data-wow-delay="1s" />
                                    </div>
                                    <div class="work-intro">
                            ...
                            <li class="work-item mix design development">
                                <a href="slick-portfolio-single.html" class="work-ext-link">
                                    <div class="work-img">
                                        <div class="work-img-bg wow-p scalexIn"></div>
                                        <img src="images/demo-slick/portfolio/project-4.jpg" alt="Work Description" class="wow-p fadeIn" data-wow-delay="1s" />
                                    </div>
                                    <div class="work-intro">
                            ...
                            <li class="work-item mix design">
                                <a href="slick-portfolio-single.html" class="work-ext-link">
                                    <div class="work-img">
                                        <div class="work-img-bg wow-p scalexIn"></div>
                                        <img src="images/demo-slick/portfolio/project-5.jpg" alt="Work Description" class="wow-p fadeIn" data-wow-delay="1s" />
                                    </div>
                                    <div class="work-intro">
                            ...
                            <li class="work-item mix design branding">
                                <a href="images/demo-slick/portfolio/project-6-large.jpg" class="work-lightbox-link mfp-image">
                                    <div class="work-img">
                                        <div class="work-img-bg wow-p scalexIn"></div>
                                        <img src="images/demo-slick/portfolio/project-6.jpg" alt="Work Description" class="wow-p fadeIn" data-wow-delay="1s" />
                                    </div>
                                    <div class="work-intro">
                                ...
                                <div class="col-lg-10 offset-lg-1 col-xl-8 offset-xl-2">
                                    <div class="row">
                                        ...
                                        <div class="col-md-7 col-lg-8 text-center text-md-start mb-sm-20">
                                            <h2 class="section-title-small mb-20">Like our creative works?</h2>
                                            <p class="text-gray mb-0">
                    ...
                    <div class="container position-relative">
                        ...
                        <div class="row">
                            ...
                            <div class="col-lg-7 col-xl-6 offset-xl-1 d-flex align-items-center">
                                <div class="w-100 position-relative">                                    
                                    ...
                                    <div class="row masonry mb-n30 wow fadeInUp">
                                                ...
                                                <blockquote class="testimonials-4-text">                                    
                                                    ...
                                                    <footer class="testimonials-4-author mt-30 clearfix">                                                    
                                                        <div class="testimonials-4-author-img float-start">
                                                            <img width="44" height="44" src="images/demo-slick/user-1.jpg" alt="Image description is here" />
                                                        </div>                                        
                                        ...
                                        <div class="col-md-6 mb-30">
                                            <div class="testimonials-4-item">
                                                ...
                                                <blockquote class="testimonials-4-text">                                    
                                                    ...
                                                    <footer class="testimonials-4-author mt-30 clearfix">                                                    
                                                        <div class="testimonials-4-author-img float-start">
                                                            <img width="44" height="44" src="images/demo-slick/user-2.jpg" alt="Image description is here" />
                                                        </div>                                        
                                                        <div class="overflow-hidden">
                                                            Emma Kande
                                                            <div class="small">
                                        ...
                                        <div class="col-md-6 mb-30">
                                            <div class="testimonials-4-item">
                                                ...
                                                <blockquote class="testimonials-4-text">                                    
                                                    ...
                                                    <footer class="testimonials-4-author mt-30 clearfix">                                                    
                                                        <div class="testimonials-4-author-img float-start">
                                                            <img width="44" height="44" src="images/demo-slick/user-3.jpg" alt="Image description is here" />
                                                        </div>                                        
                                                        <div class="overflow-hidden">
                                                            Peter Rebel
                                                            <div class="small">
                                        ...
                                        <div class="col-md-6 mb-30">
                                            <div class="testimonials-4-item">
                                                ...
                                                <blockquote class="testimonials-4-text">                                    
                                                    ...
                                                    <footer class="testimonials-4-author mt-30 clearfix">                                                    
                                                        <div class="testimonials-4-author-img float-start">
                                                            <img width="44" height="44" src="images/demo-slick/user-4.jpg" alt="Image description is here" />
                                                        </div>                                        
                                                        <div class="overflow-hidden">
                                                            Alice Watson
                                                            <div class="small">
                        ...
                        <div class="page-section pb-0 text-center">
                            ...
                            <div class="small-item-carousel black owl-carousel mb-0">
                                ...
                                <!-- Logo Item -->
                                <div class="logo-item">
                                    <img src="images/demo-slick/logotypes/client-1.png" width="215" height="75" alt="Company Name" />
                                </div>
                                <!-- End Logo Item -->
                                
                                <!-- Logo Item -->
                                <div class="logo-item">
                                    <img src="images/demo-slick/logotypes/client-2.png" width="215" height="75" alt="Company Name" />
                                </div>
                                <!-- End Logo Item -->
                                
                                <!-- Logo Item -->
                                <div class="logo-item">
                                    <img src="images/demo-slick/logotypes/client-3.png" width="215" height="75" alt="Company Name" />
                                </div>
                                <!-- End Logo Item -->
                                
                                <!-- Logo Item -->
                                <div class="logo-item">
                                    <img src="images/demo-slick/logotypes/client-4.png" width="215" height="75" alt="Company Name" />
                                </div>
                                <!-- End Logo Item -->
                                
                                <!-- Logo Item -->
                                <div class="logo-item">
                                    <img src="images/demo-slick/logotypes/client-5.png" width="215" height="75" alt="Company Name" />
                                </div>
                                <!-- End Logo Item -->
                                
                                <!-- Logo Item -->
                                <div class="logo-item">
                                    <img src="images/demo-slick/logotypes/client-6.png" width="215" height="75" alt="Company Name" />
                                </div>
                                <!-- End Logo Item -->
                    ...
                    <div class="container position-relative">
                        ...
                        <div class="row mb-60 mb-sm-40">
                            ...
                            <div class="col-lg-8 offset-lg-2 text-center mb-md-30">
                                ...
                                <h2 class="section-caption-slick mb-30 mb-sm-20">Our Blog</h2> 
                                                               
                                <h3 class="section-title mb-30">Check the latest news about our company in our blog.</h3>
                            
                                <p class="section-descr mb-0">There are three kinds of web developer specialization front-end developer, back-end developer, and full-stack developer.</p>
                            
                            </div>
                            
                            <div class="col-lg-2 d-flex align-items-end">
                                <div class="local-scroll text-center text-lg-end w-100">
                                    <a href="slick-blog.html" class="link-hover-anim" data-link-animate="y">Our blog <i class="mi-arrow-right size-24"></i></a>
                                </div>
                            </div>                             
                        ...
                        <div class="row mt-n30">
                            ...
                            <div class="post-prev-3 col-12 col-lg-10 offset-lg-1 col-xl-6 offset-xl-0 mt-30">                                
                                <div class="post-prev-3-container d-block d-sm-flex">
                                    ...
                                    <div class="post-prev-3-img">
                                        <a href="slick-blog-single.html"><img src="images/demo-slick/blog/post-prev-1.jpg" alt="Add Image Description" class="wow scaleOutIn" /></a>
                                    </div>
                                    ...
                                    <div class="post-prev-3-intro">
                                        ...
                                        <div class="post-prev-3-info clearfix">
                                            <div class="float-start">
                                                <a href="#"><img class="post-prev-3-author-img" width="30" height="30" src="images/demo-slick/user-1.jpg" alt="Image Description" /></a> <a href="#">Thomas Johnson</a>
                                            </div>
                            ...
                            <div class="post-prev-3 col-12 col-lg-10 offset-lg-1 col-xl-6 offset-xl-0 mt-30">                                
                                <div class="post-prev-3-container d-block d-sm-flex">
                                    ...
                                    <div class="post-prev-3-img">
                                        <a href="slick-blog-single.html"><img src="images/demo-slick/blog/post-prev-2.jpg" alt="Add Image Description" class="wow scaleOutIn" /></a>
                                    </div>
                                    ...
                                    <div class="post-prev-3-intro">
                                        ...
                                        <div class="post-prev-3-info clearfix">
                                            <div class="float-start">
                                                <a href="#"><img class="post-prev-3-author-img" width="30" height="30" src="images/demo-slick/user-2.jpg" alt="Image Description" /></a> <a href="#">Adam Smith</a>
                                            </div>
                                            <div class="float-end"><a href="#">August 3</a></div>
                                        </div>
                                ...
                                <div class="row">
                                    <div class="col-md-11">
                                        ...
                                        <div class="contact-item mb-30 mb-sm-20">
                                            ...
                                            <div class="ci-text">
                                                123 King Street, London W60 10250, United Kingdom
                                            </div>
                                            <div>
                                                <a href="https://goo.gl/maps/7Vw1PBhxx5BaXStr8" class="link-hover-anim" data-link-animate="y" rel="nofollow noopener" target="_blank">See Map <i class="mi-arrow-right size-18"></i></a>
                                            </div>
                                        </div>
                                        <!-- End Address -->
                                        ...
                                        <div class="contact-item mb-30 mb-sm-20">
                                            ...
                                            <div>
                                                <a href="mailto:support@bestlooker.pro" class="link-hover-anim" data-link-animate="y">Say Hello <i class="mi-arrow-right size-18"></i></a>
                                            </div>
                                        </div>                                    
                                        <!-- End Email -->
                                ...
                                <div class="row g-0">
                                    ...
                                    <div class="col-md-5 d-flex align-items-stretch pt-40 pt-sm-0 pb-40 pb-sm-0 mb-sm-30">
                                        <div class="map-boxed-1 d-flex align-items-stretch">
                                            <iframe src="https://www.google.com/maps/embed?pb=!1m14!1m8!1m3!1d6143.08567813473!2d-75.602457!3d39.660002!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x89c703f3cdadbfdb%3A0x80d20252268fc006!2zMjQ1IFF1aWdsZXkgQmx2ZCBzdGUgaywgTmV3IENhc3RsZSwgREUgMTk3MjAsINCh0L_QvtC70YPRh9C10L3RliDQqNGC0LDRgtC4INCQ0LzQtdGA0LjQutC4!5e0!3m2!1suk!2sua!4v1677158678087!5m2!1suk!2sua" width="600" height="450" style="border:0;" allowfullscreen="" loading="lazy" referrerpolicy="no-referrer-when-downgrade"></iframe>
                                        </div>
                                    </div>
                ...
                <div class="container position-relative">
                    ...
                    <div class="row pb-120 pb-sm-80 pb-xs-50">
                        ...
                        <div class="col-md-4 col-lg-3 text-gray mb-sm-50">
                            ...
                            <div class="mb-30">
                                <img src="images/demo-slick/logo-dark.svg" alt="Your Company Logo" width="106" height="36" />
                            </div>
