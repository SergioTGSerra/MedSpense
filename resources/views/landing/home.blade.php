                ...
                <div class="col-md-10 offset-md-1 col-lg-6 offset-lg-0 d-flex align-items-center mb-md-60 mb-sm-30">
                    <div class="w-100 text-center text-lg-start">
                        ...
                        <div class="local-scroll wow fadeInUp wch-unset" data-wow-delay="0.3s" data-wow-offset="0">
                            ...
                            <a href="/#about" class="link-hover-anim ms-2 ms-sm-5 me-2" data-link-animate="y">{{ __('About Us') }}<i class="mi-arrow-right size-24"></i></a>
            ...
            <div class="col-md-8 offset-md-2 col-xl-6 offset-xl-3 wow fadeInUp">
                ...
                <form id="mailchimp" class="form">
                    ...
                    <div class="form-tip">
                        ...
                        {{ __('By sending the form you agree to the')}} <a href="{{ route('terms-of-service') }}">{{ __('Terms & Conditions')}}</a> {{ __('and')}} <a href="{{ route('privacy-policy') }}"> {{ __('Privacy Policy')}}</a>.
                    </div>
                        ...
                        <div class="box-shadow bg-white round p-4 p-sm-5 position-relative z-index-1">
                            ...
                            <form class="form contact-form" id="contact_form">
                                ...
                                <div class="form-tip w-100 pt-30 mt-sm-20">
                                    <i class="icon-info size-16"></i>
                                    {{ __('All the fields are required. By sending the form you agree to the')}} <a href="{{ route('terms-of-service') }}">{{ __('Terms & Conditions')}}</a> {{ __('and')}} <a href="{{ route('privacy-policy') }}">{{ __('Privacy Policy')}}</a>.
                                </div>
                                <!-- End Inform Tip -->
